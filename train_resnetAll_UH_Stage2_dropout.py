...
dataset_name = "UH"
DEST_ROOT = f"/nobackup/users/birdy/resnet-{dataset_name}-stage2-dropout152"
...
#     # save df
#     results_df.to_csv(f"{DEST_ROOT}/{dataset_name}_stage2_dropout_results.csv", index=False)
