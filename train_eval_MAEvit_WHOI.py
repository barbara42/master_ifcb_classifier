...
dataset_name = "WHOI"
model_name = f"MAEvit_scratch_{dataset_name}_{total_epoch}"
...
log_dir = f"{DEST_ROOT}/logs/vit_cls_scratch"
...
model_name = f"vit-cls-{dataset_name}-from-scratch_{total_epoch}"
