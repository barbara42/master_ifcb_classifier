...
train_dataset = helper.WHOIDataset(data_dir, csv_file, "train", transform=helper.data_transforms["train_padToSize"])
val_dataset = helper.WHOIDataset(data_dir, csv_file, "val", transform=helper.data_transforms["val_padToSize"])
